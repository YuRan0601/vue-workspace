...
import { onMounted, ref, watchEffect } from 'vue';
    ...
    async function insertRoomTypeHandler() {
      ...
      // const { data } = await axios.post("http://localhost:8080/CloudSerenityHotel/room/type", formData, {
      //     headers: {
              ...
              <v-row dense>
                ...
                >
                  ...
                  <v-row v-if="previewUrls.length > 0" class="mt-4">
                    <v-col v-for="(url, index) in previewUrls" :key="index" cols="4">
                ...
                >
                  <v-textarea 
                  label="房型描述"
                  v-model="insertRoomType.typeDesc"></v-textarea>
                </v-col>
              </v-row>
            </v-card-text>
